...
(function(window, document) {
	...
	var prefixMethod = function (obj, method) {
	...
	for (var i = 0; i < inputs.length; i++)
	{
		...
		var down = function(e){
			...
			if ( keyCode === 122 )
			{
				if (prefixMethod(document, "FullScreen") || prefixMethod(document, "IsFullScreen")) prefixMethod(document, "CancelFullScreen");
				else prefixMethod(e, "RequestFullScreen");
				return;
			}
